    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} action="" className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        <div className="flex flex-col gap-1">
          <p>Course Title</p>
          <input onChange={e => setCourseTitle(e.target.value)} value={courseTitle}  type="text" placeholder='Type here' className='outline-none md:py-2.5 py-2 px-3 rounded-2xl
        ...
        <div className="flex flex-col gap-1">
          <p>Discount%</p>
          <input onChange={e => setDiscount(e.target.value)} value={discount}  type="number" className="outline-none md:py-2.5 w-28 px-3 rounded border border-gray-500" required />
        </div>
            ...
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              ...
              {!chapter.collapsed && (
                <div className="p-4">
                  ...
                  <div onClick = {() => handleLecture('add', chapter.chapterId)} className="inline-flex bg-gray-100 p-2 rounded cursor-pointer mt2">+ Add Lecture</div>
                </div>
              )}
            </div>
